...
let project = "Persimmon.Dried.Quotations"

// Short summary of the project
// (used as description in AssemblyInfo and as a short summary for NuGet package)
let summary = "Persimmon.Dried extension using Quotations"

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "Persimmon.Dried.Quotations is extension for Persimmon.Dried."
...
let solutionFile  = "Persimmon.Dried.Quotations.sln"
...
let gitName = "Persimmon.Dried.Quotations"
...
Target "AssemblyInfo" (fun _ ->
    let getAssemblyInfoAttributes projectName =
        [ Attribute.Title (projectName)
          ...
          Attribute.Guid "b27c7cb1-8c8d-41f9-85da-94ff8d0aab56"
